...
def main():
    ...
    output_dir = os.path.join(project_root, "mme_layer_overlap_results_text_avg")
        ...
        for sample in sample_iterator:
            ...
            for layer_idx, layer_attn in enumerate(attentions):
                ...
                if image_end - image_start < image_token_len:
                    # print(f"Warning: Sequence length {seq_len} too short. Skipping.")
                    valid_sample = False
                    break

                image_attn_scores = get_text_to_image_scores(
                    layer_attn,
                    image_start,
                    image_end,
                    prompt_start,
