...
class AdaptInfer_LlamaModel(LlamaModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.adaptinfer_sys_length = config.adaptinfer_sys_length 
        self.adaptinfer_img_length = config.adaptinfer_img_length 
        ...
        self.adaptinfer_topk = getattr(config, 'adaptinfer_topk', 64) # 动态阈值，用于决定保留数量
    ...
    def reset_adaptinfer(self):
        ...
        self.adaptinfer_topk = self.config.adaptinfer_topk
            ...
            if self.gradient_checkpointing and self.training:
                ...
                if self.use_adaptinfer and idx in self.adaptinfer_pruning_layers:
                    ...
                    if seq_length > VISUAL_END_IDX and output_attentions:
                        ...
                        important_indices_relative = visual_scores.topk(k=TOPK).indices
                        ...
                        img_seq_length = keep_indices.shape[0]  
