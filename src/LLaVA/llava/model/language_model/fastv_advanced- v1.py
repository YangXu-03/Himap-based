...
class FastvAdvanced_LlamaModel(LlamaModel):
    ...
    def _select_tokens_text_weighted(self, attention_weights, sys_length, image_token_length, attention_rank):
        ...
        # Get attention from last token: [batch, num_heads, seq_len]
        last_token_attention = attention_weights[:, :, -1, :]
        
        # Extract text-to-text attention (from last token to text tokens)
        # Text tokens are before sys_length and after sys_length+image_token_length
        text_start = 0
        text_end = sys_length
    ...
    def _select_tokens_text_weighted(self, attention_weights, sys_length, image_token_length, attention_rank):
        ...
        # Extract text-to-text attention (from last token to text tokens)
        # Text tokens are before sys_length
        text_start = 0
        text_end = sys_length
