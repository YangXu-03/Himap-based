...
from accelerate import init_empty_weights # 用于超大模型

# from .himap import Himap_LlamaModel
# from .fastv_advanced import FastvAdvanced_LlamaModel
# from .fastv import Fastv_LlamaModel
from .jsd_entropy import JSDEntropy_LlamaModel
# from .three_stage_pruning_llama import ThreeStagePruningLlamaModel
...
class LlavaLlamaModel(LlavaMetaModel, JSDEntropy_LlamaModel):
    config_class = LlavaConfig

#     def __init__(self, config: LlamaConfig):
#         super(LlavaLlamaModel, self).__init__(config)

# class LlavaLlamaModel(LlavaMetaModel, ThreeStagePruningLlamaModel):
#     config_class = LlavaConfig

    # def __init__(self, config: LlamaConfig):
    #     super(LlavaLlamaModel, self).__init__(config)

# class LlavaLlamaModel(LlavaMetaModel, FastvAdvanced_LlamaModel):
#     config_class = LlavaConfig
...
class LlavaLlamaForCausalLM_CustomSelection(LlamaForCausalLM, LlavaMetaForCausalLM):
    """使用自定义Token选择的LLaVA CausalLM模型"""
    config_class = LlavaConfig
