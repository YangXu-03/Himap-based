...
if __name__ == "__main__":
    ...
    proportions = torch.load('/root/nfs/code/HiMAP/output_example/scivqa_props-7b.pt')
    ...
    plot_props4all(props_all, '/root/nfs/code/HiMAP/output_example/scivqa-props4all-7b.png')
    plot_props4img(props_img, '/root/nfs/code/HiMAP/output_example/scivqa-props4img-7b.png')